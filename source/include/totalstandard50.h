#ifndef TOTALSTANDARD50_H
#define TOTALSTANDARD50_H

#ifdef TOTALSTANDARD50_DLL
#  ifdef WIN32
#  define TOTALSTANDARD50_EXPORT __declspec(dllexport)
#  else
#  define TOTALSTANDARD50_EXPORT
#  endif
#else
#  ifdef WIN32
#  define TOTALSTANDARD50_EXPORT __declspec(dllimport)
#  else
#  define TOTALSTANDARD50_EXPORT
#  endif
#endif
...
class TOTALSTANDARD50_EXPORT TotalStandardDlg50 : public QWidget
{
	Q_OBJECT

public:
	TotalStandardDlg50(QWidget *parent = 0, Qt::WFlags flags = 0);
	~TotalStandardDlg50();
